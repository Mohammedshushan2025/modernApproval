...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  Widget _buildBody(bool isRtl) {
    ...
    return Padding( // <-- تم تغيير Container إلى Padding
      padding: EdgeInsets.fromLTRB(
          horizontalPadding,
          verticalSpacing,
          horizontalPadding,
      ...
      child: Column(
        children: [
          ...
          _buildModernProfileCard(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  // --- ✅ تم إصلاح هذا السطر ليمرر كائن المستخدم كاملاً ---
                  builder: (context) => ProfileScreen(user: widget.user.usersCode),
                ),
              );
            },
          ...
          SizedBox(height: verticalSpacing),
          // --- ✅ تمرير الإحصائيات وحالة التحميل ---
  ...
  // --- ✅ تعديل لاستقبال الأعداد وحالة التحميل ---
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        // --- ✅ تعديل بسيط هنا لضمان ظهور الكلمة ---
                        Text(
                          title,
                          style: TextStyle(
                            color: Colors.black,
                          ...
                          maxLines: 1, // سطر واحد
                          overflow: TextOverflow.ellipsis, // نقاط لو أطول
                          softWrap: false, // لا تنزل سطر جديد
                        ),
                        SizedBox(height: isShortScreen ? 2 : 5),
                        Flexible(
                          child: Text(
        ...
        children: [
          Row(
            children: [
              ...
              Text(
                isRtl ? 'إحصائيات' : "Stats", // تغيير العنوان
                style: TextStyle(
          ...
          Row(
            children: [
              ...
              Expanded(
                child: _buildStatCard(
                  icon: Icons.check_circle_outline, // أيقونة أنسب
                  value: approvedValue,
                  label: l.translate('approved'), // استخدام الترجمة
              ...
              Expanded(
                child: _buildStatCard(
                  icon: Icons.highlight_off, // أيقونة أنسب
                  value: rejectedValue,
                  label: l.translate('rejected'), // استخدام الترجمة
  ...
  Widget _buildStatCard({
    ...
    return Container(
      ...
      child: Column(
        children: [
          // --- ✅ إظهار تحميل أو الأيقونة ---
          value == '...'
              ? const SizedBox(
            width: 22, // نفس حجم الأيقونة
            height: 22,
          ...
          Container(
            ...
            // --- ✅ إضافة شريط تحميل متحرك ---
            child: value == '...'
                ? const LinearProgressIndicator() // شريط تحميل
                : FractionallySizedBox(
              alignment: AlignmentDirectional.centerStart,
              widthFactor: progress.isNaN ? 0.0 : progress, // التأكد من عدم تمرير NaN
              child: Container(
                decoration: BoxDecoration(
                  color: color,
                  borderRadius: BorderRadius.circular(2),
