...
class ProductionOutboundApprovalScreen extends StatefulWidget {
...
class _ProductionOutboundApprovalScreenState
  ...
  List<ProductionOutbound> _filteredRequests = [];
  ...
  void _fetchData() {
    setState(() {
      _requestsFuture = _apiService.getProductionOutbound(
  ...
  void _applyFilters(List<ProductionOutbound> allRequests) {
    setState(() {
      _filteredRequests =
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // List content
          Expanded(
            child: FutureBuilder<List<ProductionOutbound>>(
