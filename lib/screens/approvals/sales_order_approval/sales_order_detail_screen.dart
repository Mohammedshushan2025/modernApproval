...
class _SalesOrderDetailScreenState extends State<SalesOrderDetailScreen>  {
        ...
        children: [
          FutureBuilder<Map<String, dynamic>>(
            ...
            builder: (context, snapshot) {
              ...
              final masterData =
              snapshot.data!['master'] as SalesOrderMaster;
              final detailData =
          ...
          child: Column(
            ...
            children: [
              ...
              _buildCompactInfoRow(
                ...
                isArabic?master.storeNameA??'N/A':master.storeNameE ?? 'N/A',
              ),
  ...
  // ========================================================
  Future<void> _printDocument(AppLocalizations l, bool isArabic,SalesOrderMaster salesOrderMaster ) async {
    try {
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  pw.Row(
                      ...
                      children: [
                        pw.Text("اسم العميل:"),
                        pw.Text("${master.customerNameA??master.customerNameE}",style:pw.TextStyle(font: ttf, fontSize: 9)),
                      ]),
                  pw.Text(":Store Name"),pw.Row(
                      mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                      children: [
                        pw.Text("رقم المخزن:"),
  ...
  pw.Widget _buildPdfTableTotalPriceSkeleton(List<SalesOrderDetails> listSalesOrderDetail,pw.Font ttf,){
  ...
  pw.Widget _buildPdfTotalTable(SalesOrderMaster salesOrderMaster,List<SalesOrderDetails> listSalesOrderDetail){
    double grandTotalBeforeCalc = listSalesOrderDetail.fold(0.0, (sum, item) => sum + item.totPrice!); // الاجمالي قبل الحسابات
